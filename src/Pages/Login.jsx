...
import { login } from "../Services/ServiceIndex";
...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    ...
    // email.current.value = "akshit001@gmail.com";
    // password.current.value = 1234567;
    email.current.value = import.meta.env.VITE_HOST_GUEST_LOGIN;
    password.current.value = import.meta.env.VITE_HOST_GUEST_PASSWORD;
    try{
      const authDetail = {
        email: email.current.value,
        password: password.current.value
